class TemplateGcode():
    ...
    def getInitGcode(self):
        ...
        cmd.append('G21 G17 G90') # Set units to millimeters, select XY plane, use g91 relative positioning, use g90 absolute positioning'
